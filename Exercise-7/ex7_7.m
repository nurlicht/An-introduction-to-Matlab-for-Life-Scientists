...
% 7. Sensitivity Analysis 1: Noise
...
% New part(7)
Amplitude_Noise = 0.01 * mean([Amplitude_1 Amplitude_2]);
noiseFunction = Amplitude_Noise * randn(size(Time)); 
Intensity_All = Intensity_1 + Intensity_2 + noiseFunction;
%
